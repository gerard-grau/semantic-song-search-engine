...
(embedded_songs_2d.parquet, generated by data_pipeline.py).  If that file
does not exist the projections are computed on-the-fly and cached.
Filtered subsets always recompute t-SNE on the surviving songs.
"""
